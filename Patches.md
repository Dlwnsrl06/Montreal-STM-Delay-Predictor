06-10-2026: Completed building the ml-model, created piplines to automate the training, created logs to record the training process, built a Jupyter notbook to visualize results of this project 
